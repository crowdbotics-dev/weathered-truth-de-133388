"""
Django settings for weathered_truth_de_133388 project.
...
ROOT_URLCONF = 'weathered_truth_de_133388.urls'
...
WSGI_APPLICATION = 'weathered_truth_de_133388.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_truth_de_133388 API",
    "DESCRIPTION": "API documentation for weathered_truth_de_133388 App",
    "VERSION": "v1",
}
